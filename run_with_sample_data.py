...
def get_user_choice():
    """Get user choice between sample data and custom input."""
    print("🏠 Mortgage Amortization Calculator")
    print("=" * 50)
    print("Choose an option:")
    print("1. Use sample data (predefined rates)")
    print("2. Enter your own mortgage rates")
...
def get_custom_loan_input():
    """Get custom loan details from user input."""
    print("\n🏠 Custom Mortgage Input")
    print("=" * 40)
...
def run_custom_analysis():
    """Run mortgage analysis with custom user input."""
    loans_data = get_custom_loan_input()
    ...
    # Generate comparison plots
    visualizer.plot_loan_comparison(comparison, "output/custom_loan_comparison.png")
    visualizer.plot_balance_comparison(comparison, "output/custom_balance_comparison.png")
    visualizer.create_interactive_dashboard(comparison, "output/custom_dashboard.html")
    ...
    comparison_df.to_csv("output/custom_loan_comparison.csv", index=False)
    ...
    for loan in loans:
        ...
        print(f"  • {safe_name}_amortization.png - {loan.loan_name} amortization chart")
        print(f"  • {safe_name}_amortization.csv - {loan.loan_name} detailed data")
    print("  • custom_loan_comparison.png - Side-by-side loan comparison")
    print("  • custom_balance_comparison.png - Balance comparison over time")
    print("  • custom_dashboard.html - Interactive dashboard")
    print("  • custom_loan_comparison.csv - Summary comparison data")
